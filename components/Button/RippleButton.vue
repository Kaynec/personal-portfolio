  ...
  <button
    ...
    :class="
      cn(
        ...
        'rounded-lg   border-[1px] border-[#cccccc33] px-4 py-2 text-center text-white',
        $props.class
      )
    "
  ...
  >
    ...
    <span class="pointer-events-none absolute inset-0">
      <span
        ...
        :key="ripple.key"
        class="ripple-animation absolute rounded-full border-[1px] border-[#cccccc33] opacity-30"
        :style="{
